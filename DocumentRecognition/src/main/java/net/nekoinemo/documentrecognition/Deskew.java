...
class Deskew {
	...
	private static int getByteWidth(final int width) {

		return (width + 7) / 8;
	}
	private static int next_pow2(final int n) {
	...
	private static void radon(final int width, final int height, final DataBuffer buffer, final int sign, final int sharpness[]) {
